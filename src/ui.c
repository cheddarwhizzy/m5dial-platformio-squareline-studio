...
lv_obj_t *ui_Light_Control_Screen;
lv_obj_t *ui_Brightness;
void ui_event_Switch1( lv_event_t * e);
lv_obj_t *ui_Switch1;
lv_obj_t *ui_Light_Title;
...
if ( event_code == LV_EVENT_VALUE_CHANGED) {
      _ui_screen_change( &ui_Light_Control_Screen, LV_SCR_LOAD_ANIM_MOVE_LEFT, 500, 0, &ui_Light_Control_Screen_screen_init);
}
}
void ui_event_Switch1( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
if ( event_code == LV_EVENT_CLICKED) {
      _ui_checked_set_text_value( ui_Brightness, target, "45%", "Alien Chill");
}
}
...
ui_Light_Control_Screen_screen_init();
